...
<title>Origen Restaurante</title>
<link rel="icon" type="image/png" href="favicon.ico">

<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
<link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
<link href="/css/origen.css" rel="stylesheet">
<link href="/css/origen_experiencias.css" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg fixed-top">
     ...
     <a class="navbar-brand ms-3" href="#"> <img   class="img-fluid logo" src="/img-origen/logo-origen-dorado.png" alt="restaurant origen cusco logo"></a>
  ...
  <div class="row align-items-center">
    <div class="col-12 col-lg-6"  data-aos="zoom-in-right" data-aos-duration="1000"  data-aos-easing="ease-in-sine">
      ...
      <p class="text-center">
       ...
       En Origen Cusco cada plato ha sido creado como una expresión de identidad, donde la gastronomía se convierte en un relato de nuestra cultura. A través de ingredientes locales, técnicas cuidadas y una presentación contemporánea, cada preparación representa una parte de nuestras raíces y tradiciones, reinterpretadas con respeto y creatividad para ofrecer una experiencia auténtica y significativa.
    ...
    <div class="col-md-6 img-container"  data-aos="zoom-in-left"  data-aos-duration="1000"  data-aos-easing="ease-in-sine" id="imgsection">
      <div class="img-box">
        <img src="/img-origen/origen-sec-1.png"
...
<section class="section container-fluid">
  <div class="row align-items-center flex-md-row-reverse">
    ...
    <div class="col-md-6 img-container" data-aos="fade-right" data-aos-duration="1000"  data-aos-easing="ease-in-sine" id="imgsection">
      <div class="img-box">
        <img src="/img-origen/origen-sec-2.png"
     class="img-fluid w-100"
     alt="Origen Cusco">
      </div>
    </div>
...
<section class="section container gallery separate-2"  id="galeria">
  ...
  <div class="p-2 row g-3 gallery">
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="1500"><img src="/img-origen/galeria-origen-1.png"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="1500"><img src="/img-origen/galeria-origen-2.png"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="1500"><img src="/img-origen/galeria-origen-3.png"></div>
  </div>
   <div class="p-2 row g-3 gallery">
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="2000"><img src="/img-origen/galeria-origen-4.png"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="2000"><img src="/img-origen/galeria-origen-5.png"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="2000"><img src="/img-origen/galeria-origen-6.png"></div>
  </div>
</section>
...
<div class="collapse" id="collapseExample">
  ...
  <div class="row">
      <div class="col-12 text-end mt-4">
                    <a target="_blank" href="/portafolio-origen/Portafolio_origen.pdf" type="button" class="btn btn-warning btn-lg p-3" id="conoce-mas">Conoce más</a>
...
<section class="section text-center pt-5">
  <img src="/img-origen/iso-origen.png" class="img-fluid" style="max-width: 200px;">
</section>

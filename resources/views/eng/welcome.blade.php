...
<nav class="navbar navbar-expand-lg fixed-top">
     <a class="navbar navbar-brand ms-3" href="#"> 
         <img class="img-fluid logo" src="/img-origen/logo-origen-dorado.webp" alt="restaurant origen cusco " width="160" height="55" fetchpriority="high">
     </a>
...
<section class="hero-ultra min-vh-100 d-flex align-items-center justify-content-center">
  ...
  <div class="hero-content text-center">
    ...
    <a href="{{route('reservas_comensales')}}" class="btn-reserva-main">BOOK A TABLE WITH US</a>
  </div>
</section>
...
<section class="section text-center mt-5 mb-5">
  <div class="container py-5 px-3">
    ...
    <p class="mx-auto" style="max-width:1800px;" data-aos="fade-up" data-aos-duration="1300" data-aos-easing="ease-in-sine">
       Origen Cusco invites us to reconnect with our roots through an experience that honors Cusconian tradition from a contemporary perspective. Its concept integrates architecture, materials, and gastronomy inspired by Peru's identity, creating a space where history feels alive and expresses itself with elegance, authenticity, and character.
    </p>
  </div>
</section>
  ...
  <div class="row align-items-center">
    <div class="col-12 col-lg-6" data-aos="zoom-in-right" data-aos-duration="1000" data-aos-easing="ease-in-sine">
       <div class="p-3 p-md-5">
          <h2 class="text-start mb-4">Gastronomy</h2>
          <p class="text-start">
             At Origen Cusco, each dish has been created as an expression of identity, where gastronomy becomes a narrative of our culture. Through local ingredients, meticulous techniques, and a contemporary presentation, each preparation represents a piece of our roots and traditions, reinterpreted with respect and creativity to offer an authentic and meaningful experience.
          </p>
  ...
  <div class="modal-dialog">
    <div class="modal-content" id="background_experiencias">
      <div class="modal-header">
        <h5 class="modal-title fw-bolder" id="staticBackdropLabel" style="color: #D8B36A !important; font-size: 1.5rem;">MENUS & CARDS</h5>
...
<section class="section container-fluid">
  <div class="row align-items-center flex-md-row-reverse">
    <div class="col-md-6" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-easing="ease-in-sine">
        <div class="p-5">
            <h2 class="text-end mb-4 pe-4">Our Concept</h2>
            <p class="text-center">
              Origen is a celebration of our roots, a gastronomic proposal inspired by the cultural, historical, and natural richness of our land. Each dish is born from a constant search for the flavors that define us, rescuing ancestral ingredients, culinary traditions, and knowledge passed down from generation to generation.
            </p>
        </div>
    </div>
...
<section class="section container gallery separate-2" id="galeria">
  <div class="section text-center mt-5 mb-5" data-aos="fade-up" data-aos-duration="1000">
    <div class="container">
      <h2 class="mb-4 mt-3">Gallery</h2> 
    </div>
  </div>
  <div class="p-2 row g-3 gallery">
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="1500"><img src="/img-origen/galeria-origen-1.webp" alt="Gallery Origen 1" loading="lazy" width="400" height="300"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="1500"><img src="/img-origen/galeria-origen-2.webp" alt="Gallery Origen 2" loading="lazy" width="400" height="300"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="1500"><img src="/img-origen/galeria-origen-3.webp" alt="Gallery Origen 3" loading="lazy" width="400" height="300"></div>
  </div>
  <div class="p-2 row g-3 gallery">
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="2000"><img src="/img-origen/galeria-origen-4.webp" alt="Gallery Origen 4" loading="lazy" width="400" height="300"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="2000"><img src="/img-origen/galeria-origen-5.webp" alt="Gallery Origen 5" loading="lazy" width="400" height="300"></div>
    <div class="col-md-4" data-aos="zoom-in-up" data-aos-duration="2000"><img src="/img-origen/galeria-origen-6.webp" alt="Gallery Origen 6" loading="lazy" width="400" height="300"></div>
  </div>
</section>
  ...
  <div class="card card-body" id="background_experiencias">
    <div class="experience-card">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md text-center">
                <h5 class="card-title text-center">CEVICHE COOKING CLASS</h5>
            </div>
        </div>
    </div>
    ...
    <div class="experience-card">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md text-center">
                <h5 class="card-title text-center">PISCO SOUR MAKING</h5>
            </div>
        </div>
    </div>
    ...
    <div class="experience-card">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md text-center">
                <h5 class="card-title text-center">CAUSA COOKING CLASS</h5>
            </div>
        </div>
    </div>
...
<section class="section text-center mt-5 mb-5" id="reservas">
  <h2 class="text-center mb-2">Book Your Experience</h2>
...
<section class="section text-center pt-5">
  <img src="/img-origen/iso-origen.webp" class="img-fluid" style="max-width: 200px;" alt="Isotype Origen" loading="lazy" width="200" height="200">
</section>
...
<footer class="container-fluid footer-catedral pb-3" id="contactanos">
    ...
    <div class="row gy-4 mt-3">
        <div class="col-12 col-md-6 text-center text-md-start">
          ...
          <a href="{{route('reservas_comensales')}}" class="btn-reserva mt-3 mb-4">BOOK A TABLE WITH US</a>
          <div class="d-flex flex-column gap-2 align-items-center align-items-md-start mt-3">
